...
class CustomerService {
    ...
    // .join() above is used to make the code as blocking operation. This is just to get away with changes quickly. Will be changed lateron.
    // As discussed,  thenApply takes care to send CompletableFuture
